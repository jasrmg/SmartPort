...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const resoModal = document.getElementById("resolutionDetailsModal");
  const closeResoModal = document.getElementById("closeResolutionDetailsModal");
  const okResolutionBtn = document.getElementById("okResolutionBtn");

  closeResoModal.addEventListener("click", () => {
    resoModal.style.display = "none";
  });
